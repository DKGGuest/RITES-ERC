...
const MOCK_DIMENSIONAL_DATA = [
    { batchNo: 'B-701', batchTotal: 160, sleeperType: 'RT-1234', typeQty: 80, testedPct: 100, status: 'Completed', date: '2026-02-01', spec: 'T-39' },
    { batchNo: 'B-702', batchTotal: 160, sleeperType: 'RT-5678', typeQty: 160, testedPct: 45, status: 'Under Inspection', date: '2026-02-02', spec: 'T-45' },
    { batchNo: 'B-703', batchTotal: 80, sleeperType: 'RT-9012', typeQty: 80, testedPct: 0, status: 'Pending', date: '-', spec: 'T-39' },
];

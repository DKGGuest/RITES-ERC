...
const MoistureEntryForm = ({ onCancel, onSave, initialData }) => {
    ...
    const calculateAggregate = useCallback((aggType) => {
    ...
    }, [aggData, commonData.userDryCA1, commonData.userDryCA2, commonData.userDryFA]);

    const ca1Calc = useMemo(() => calculateAggregate('ca1'), [calculateAggregate]);
    const ca2Calc = useMemo(() => calculateAggregate('ca2'), [calculateAggregate]);
    const faCalc = useMemo(() => calculateAggregate('fa'), [calculateAggregate]);

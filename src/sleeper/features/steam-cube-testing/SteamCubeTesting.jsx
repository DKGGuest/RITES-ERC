...
const TestDetailsModal = ({ sample, onClose, onSave, isModifying }) => {
    ...
    const calculateAge = React.useCallback((castDate, castTime, testDate, testTime) => {
    ...
    }, [sample.castDate, sample.castTime, calculateAge]); // Run when sample casting info is available

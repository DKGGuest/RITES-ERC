...
export const MOCK_INSPECTION_CALLS = [
  { id: 'CALL-2025-001', callNumber: 'CALL-2025-001', ie: MOCK_IES[0], vendor: MOCK_VENDORS[0], product: PRODUCT_TYPES.ERC, stage: INSPECTION_STAGES.RAW_MATERIAL, status: CALL_STATUS.UNDER_INSPECTION, scheduledDate: '2025-01-15', slaBreached: false, daysPending: 5 },
  { id: 'CALL-2025-002', callNumber: 'CALL-2025-002', ie: MOCK_IES[1], vendor: MOCK_VENDORS[1], product: PRODUCT_TYPES.SLEEPER, stage: INSPECTION_STAGES.PROCESS, status: CALL_STATUS.IC_PENDING, scheduledDate: '2025-01-08', slaBreached: true, daysPending: 12 },
  { id: 'CALL-2025-003', callNumber: 'CALL-2025-003', ie: MOCK_IES[2], vendor: MOCK_VENDORS[2], product: PRODUCT_TYPES.GRSP, stage: INSPECTION_STAGES.FINAL, status: CALL_STATUS.ASSIGNED, scheduledDate: '2025-01-25', slaBreached: false, daysPending: 0 },
  { id: 'CALL-2025-004', callNumber: 'CALL-2025-004', ie: MOCK_IES[3], vendor: MOCK_VENDORS[3], product: PRODUCT_TYPES.ERC, stage: INSPECTION_STAGES.RAW_MATERIAL, status: CALL_STATUS.BILLING_PENDING, scheduledDate: '2024-12-25', slaBreached: false, daysPending: 0 },
  { id: 'CALL-2025-005', callNumber: 'CALL-2025-005', ie: MOCK_IES[4], vendor: MOCK_VENDORS[4], product: PRODUCT_TYPES.SLEEPER, stage: INSPECTION_STAGES.PROCESS, status: CALL_STATUS.SCHEDULED, scheduledDate: '2025-01-25', slaBreached: false, daysPending: 3 },
  { id: 'CALL-2025-006', callNumber: 'CALL-2025-006', ie: MOCK_IES[0], vendor: MOCK_VENDORS[0], product: PRODUCT_TYPES.GRSP, stage: INSPECTION_STAGES.FINAL, status: CALL_STATUS.DISPOSED, scheduledDate: '2024-11-15', slaBreached: false, daysPending: 0 },
  { id: 'CALL-2025-007', callNumber: 'CALL-2025-007', ie: MOCK_IES[1], vendor: MOCK_VENDORS[1], product: PRODUCT_TYPES.ERC, stage: INSPECTION_STAGES.RAW_MATERIAL, status: CALL_STATUS.PAYMENT_PENDING, scheduledDate: '2024-12-20', slaBreached: false, daysPending: 0 },
  { id: 'CALL-2025-008', callNumber: 'CALL-2025-008', ie: MOCK_IES[2], vendor: MOCK_VENDORS[2], product: PRODUCT_TYPES.SLEEPER, stage: INSPECTION_STAGES.PROCESS, status: CALL_STATUS.UNDER_INSPECTION, scheduledDate: '2025-01-18', slaBreached: true, daysPending: 7 }
];
